...
# ====================================================================
# 4. BATCHED PERFORMANCE VERIFICATION PIPELINE (TRAIN DATASET TARGET)
# ====================================================================
def verify_on_training_data():
    ...
    # 🎯 TARGET ALIGNMENT: Evaluating strictly on the original training images
    TEST_CSV = os.path.join(CLEAN_BASE, 'Train_Label.csv')
    TEST_DIR = os.path.join(CLEAN_BASE, 'train')
    ...
    print(f"\n🔍 Running Model Recognition on {len(eval_ds)} TRAINING Images:\n" + "=" * 50)
